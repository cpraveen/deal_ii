...
nv = 30; // points in wall normal direction
nw = 20; // points on wake

ra = 0.1; // bump ratio for airfoil upper/lower side
ro = 1.4; // in wall normal direction
rw = 1.45; // along wake
...
Line(8) = {1003, 1004};
Line(9) = {1004, 1};
Compound BSpline(10) = {5,6} Using na;
Compound BSpline(11) = {7,8} Using na;
Line(12) = {1,1005};
Line(13) = {1005, 1006};
Line(14) = {1005, 1007};
Line(15) = {1006, 1000};
