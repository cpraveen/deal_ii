...
namespace Step8
{
  ...
  void ElasticProblem<dim>::setup_system()
  {
    ...
    for(int i=0; i<3; ++i)
      VectorTools::interpolate_boundary_values(dof_handler,
                                               ...
                                               constraints);
    std::string constants = "pi=3.141592653589793";
    static const FunctionParser<dim> top_displacement("0; 0.1*sin(2*pi*x)",
                                                      constants);
    VectorTools::interpolate_boundary_values(dof_handler,
                                             types::boundary_id(3),
                                             top_displacement,
  ...
  void ElasticProblem<dim>::output_results() const
  {
    ...
    MappingQEulerian<dim> mapping(fe.degree, dof_handler, solution);
