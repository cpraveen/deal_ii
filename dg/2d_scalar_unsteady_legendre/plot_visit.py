'''
Run this as follows
    visit -cli -nowin -s ./vis_vortex.py
'''
import sys
...
OpenDatabase("sol-*.vtk database")

v = GetView2D()
#v.windowCoords = (-10.0, 10.0, -10.0, 10.0)
v.viewportCoords = (0.1, 0.85, 0.07, 0.95)
#v.fullFrameActivationMode = v.On
SetView2D(v)

s = SaveWindowAttributes()
s.format = s.PNG                    # PNG or POSTSCRIPT
s.fileName = variable+"_"
...
a.axes2D.xAxis.title.visible = 1  # (0,1): Disable/enable display of axis title
